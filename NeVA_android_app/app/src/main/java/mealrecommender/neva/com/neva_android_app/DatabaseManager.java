...
public class DatabaseManager {
  ...
  private String mealTableColumns[] = {DatabaseHelper.MEAL_ID, DatabaseHelper.MEAL_NAME,
      DatabaseHelper.MEAL_PHOTO};
  private String historyTableColumns[] = {DatabaseHelper.HISTORY_USER_MAIL,
      DatabaseHelper.HISTORY_MEAL, DatabaseHelper.HISTORY_DATE};
  ...
  public Cursor getHistory() {
    ...
    for (int i = 0; i < cursor.getCount(); i++) {
      Log.d("Cursor: ",
          cursor.getString(0) + " " + cursor.getString(1) + " " + cursor.getString(2) + " " + cursor
              .getString(3));
      cursor.moveToNext();
    }
    return cursor;
