...
import mealrecommender.neva.com.neva_android_app.util.HistoryCursorAdapter;
...
import mealrecommender.neva.com.neva_android_app.fragments.UserFragment;
import mealrecommender.neva.com.neva_android_app.fragments.AddHistoryItemFragment;
import mealrecommender.neva.com.neva_android_app.fragments.HistoryFragment;
import mealrecommender.neva.com.neva_android_app.fragments.ProposeFragment;
import mealrecommender.neva.com.neva_android_app.fragments.RecommendFragment;
...
public class MainActivity extends AppCompatActivity
  ...
  public TextView navdrawUsername;
  public HistoryCursorAdapter adapter;
  ...
  public boolean onNavigationItemSelected(MenuItem item) {
    ...
    if (id == R.id.nav_recommend) {
      ...
      getSharedPreferences("mealrecommender.neva.com.loginstat", MODE_PRIVATE).edit().putBoolean("LOGGED_IN", false).commit();
