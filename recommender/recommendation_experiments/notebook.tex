...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{k+kn}{import} \PY{n+nn}{os}\PY{o}{,}\PY{n+nn}{sys}\PY{o}{,}\PY{n+nn}{inspect}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{k+kn}{import} \PY{n+nn}{utils}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}48}]:} \PY{n}{all\PYZus{}user\PYZus{}ids} \PY{o}{=} \PY{n+nb}{list}\PY{p}{(}\PY{n}{utils}\PY{o}{.}\PY{n}{GetUserIDs}\PY{p}{(}\PY{p}{)}\PY{p}{)}
...
20 []
32 []
57 [(0, 0.2509523809523809), (-1, 0.0), (-1, 0.05), (31, 0.10857142857142857), (-1, 0.025), (-1, 0.19333333333333333), (-1, 0.11166666666666666), (5, 0.16666666666666666), (-1, 0.14166666666666666), (0, 0.1), (-1, 0.0), (-1, 0.23333333333333334), (33, 0.175), (-1, 0.05), (8, 0.1), (1, 0.175), (30, 0.025), (7, 0.15), (-1, 0.13999999999999999), (35, 0.025), (38, 0.045), (-1, 0.016666666666666666), (-1, 0.0), (-1, 0.016666666666666666), (35, 0.025), (-1, 0.08249999999999999), (37, 0.025), (-1, 0.14999999999999997), (1, 0.13333333333333333), (-1, 0.08678571428571429), (26, 0.08166666666666667), (25, 0.0), (-1, 0.0), (27, 0.155), (-1, 0.05), (38, 0.06999999999999999), (0, 0.15), (36, 0.0625), (36, 0.0), (37, 0.18333333333333332), (35, 0.06999999999999999), (-1, 0.075), (33, 0.025), (-1, 0.06999999999999999), (30, 0.1), (-1, 0.0)]
4 [(-1, 0.02), (-1, 0.08333333333333333)]
30 [(-1, 0.08333333333333333), (-1, 0.03428571428571429), (-1, 0.06666666666666667), (19, 0.13333333333333333), (-1, 0.29166666666666663), (-1, 0.0)]
39 []
56 []
9 [(-1, 0.075), (-1, 0.05833333333333333), (-1, 0.1392857142857143), (-1, 0.09333333333333334)]

    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}49}]:} \PY{n}{accuracies} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}52}]:} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{18}\PY{p}{,} \PY{l+m+mi}{16}\PY{p}{)}\PY{p}{,} \PY{n}{dpi}\PY{o}{=}\PY{l+m+mi}{80}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}53}]:} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{18}\PY{p}{,} \PY{l+m+mi}{16}\PY{p}{)}\PY{p}{,} \PY{n}{dpi}\PY{o}{=}\PY{l+m+mi}{80}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}20}]:} \PY{n}{accuracies} \PY{o}{=} \PY{p}{\PYZob{}}\PY{p}{\PYZcb{}}
         \PY{k}{for} \PY{n}{user\PYZus{}id} \PY{o+ow}{in} \PY{n}{user\PYZus{}ids}\PY{p}{:}
           \PY{n}{accuracies}\PY{p}{[}\PY{n}{user\PYZus{}id}\PY{p}{]} \PY{o}{=} \PY{n}{utils}\PY{o}{.}\PY{n}{MeasureAccuracy}\PY{p}{(}\PY{n}{user\PYZus{}id}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}21}]:} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{18}\PY{p}{,} \PY{l+m+mi}{16}\PY{p}{)}\PY{p}{,} \PY{n}{dpi}\PY{o}{=}\PY{l+m+mi}{80}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{18}\PY{p}{,} \PY{l+m+mi}{16}\PY{p}{)}\PY{p}{,} \PY{n}{dpi}\PY{o}{=}\PY{l+m+mi}{80}\PY{p}{)}
